...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-change-me-before-production-use')
...
TEMPLATES = [
    {
        ...
        # Look for templates in the app's templates/ folder
...
# Using SQLite for simplicity; easy to swap for PostgreSQL in production
DATABASES = {
    'default': {
...
# Message storage backend — uses cookies + session
